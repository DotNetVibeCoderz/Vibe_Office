...
namespace VibeDesk.Migrations.PostgreSql;
...
{
    private const string PlaceholderConnection = "Host=localhost;Database=VibeDesk;Username=postgres;Password=vibedesk";
    ...
    public AppDbContext CreateDbContext(string[] args)
    {
        ...
        DatabaseRegistration.ConfigureProvider(builder, DatabaseProviderKind.PostgreSql, connectionString);
