...
namespace VibeDesk.Migrations.SqlServer;
...
{
    private const string PlaceholderConnection = "Server=localhost;Database=VibeDesk;Trusted_Connection=True;TrustServerCertificate=True";
    ...
    public AppDbContext CreateDbContext(string[] args)
    {
        ...
        DatabaseRegistration.ConfigureProvider(builder, DatabaseProviderKind.SqlServer, connectionString);
