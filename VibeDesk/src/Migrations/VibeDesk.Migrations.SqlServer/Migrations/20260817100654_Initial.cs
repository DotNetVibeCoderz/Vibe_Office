        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IconEmoji = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    Surfaces = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppContext = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    DriveItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    SystemPromptOverride = table.Column<string>(type: "nvarchar(max)", maxLength: 8000, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrashedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cursor = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarColor = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    AvatarKey = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecurrenceByDay = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    RecurringSeriesId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    OriginalStartUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    IsCancelled = table.Column<bool>(type: "bit", nullable: false),
                    SourceSpreadsheetId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SourceRange = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DriveItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ParentCommentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Kind = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Body = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Anchor = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAutoSnapshot = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
