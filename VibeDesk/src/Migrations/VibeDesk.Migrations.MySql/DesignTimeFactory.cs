...
namespace VibeDesk.Migrations.MySql;
...
{
    private const string PlaceholderConnection = "Server=localhost;Database=VibeDesk;User=root;Password=vibedesk";
    ...
    public AppDbContext CreateDbContext(string[] args)
    {
        ...
        DatabaseRegistration.ConfigureProvider(builder, DatabaseProviderKind.MySql, connectionString);
